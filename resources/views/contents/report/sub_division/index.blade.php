                    ...
                    <div class="card info-card pb-3">
                        <div class="filter w-50">
                            <div class="row float-end col-md-12">
                                <form class="search-form d-flex align-items-center float-end" action="{{ route('reportSubDivision.filter') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="accordion-body mt-3">
                                        <div class="card-body">
                                            <div id="table-container">
                                                ...
                                                @include('contents.report.sub_division.partials.report1')
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-body mt-3">
                                        <div class="card-body">
                                            <div id="table-container">
                                                ...
                                                @include('contents.report.sub_division.partials.report2')
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-body mt-3">
                                        <div class="card-body">
                                            <div id="table-container">
                                                ...
                                                @include('contents.report.sub_division.partials.report3')
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-body mt-3">
                                        <div class="card-body">
                                            <div id="table-container">
                                                ...
                                                @include('contents.report.sub_division.partials.report4')
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-body mt-3">
                                        <div class="card-body">
                                            <div id="table-container">
                                                ...
                                                @include('contents.report.sub_division.partials.report5')
                                            </div>
                                        </div>
                                    </div>
                                </div>
