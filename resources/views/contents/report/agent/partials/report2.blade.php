    ...
    <table class="table table-bordered">
        ...
        <tbody class="text-uppercase" style="height: 45px;font-size:13px;">
            ...
            <tr class="bg-light text-end">
                ...
                @php
                    $avgTotal1  = \Carbon\Carbon::parse($total2[0]);
                    $avgTotal2  = \Carbon\Carbon::parse($total2[1]);
                @endphp
                @if( $total1[0] >= 3600 AND $total1[1] >= 3600)
