                    ...
                    <div class="col-12">
                        <div class="card info-card">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <form class="row g-3 mb-3" action="{{ route('item.update', ['id' => encrypt($item->id)]) }}" method="POST">
                                    @method('put')
                                    @csrf
                                    <div class="col-md-3">
                                        <label for="name" class="form-label">Item Name</label>
                                        <input type="text" name="name" class="form-control text-capitalize @error('name') is-invalid @enderror" id="name" value="{{ old('name', $item->name) }}" required>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="uom" class="form-control text-capitalize @error('uom') is-invalid @enderror" id="uom" value="{{ old('uom', $item->uom) }}" required>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select @error('category_asset_id') is-invalid @enderror" name="category_asset_id" id="category_asset_id">
                                            ...
                                            @foreach($category_assets as $ca)
                                                @if(old('category_asset_id', $item->category_asset_id) == $ca->id)
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="/clients"><button type="button" class="btn btn-secondary float-start"><i class="bi bi-arrow-return-left me-1"></i> Back</button></a>
                                    </div>
                                </form><!-- End Input Form -->
                            </div><!-- End Card Body -->
                        </div><!-- End Info Card -->
