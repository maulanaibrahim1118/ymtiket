                    ...
                    <div class="col-12">
                        <div class="card info-card">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <a href="/category-sub-tickets/create"><button type="button" class="btn btn-primary position-relative float-start me-2" style="margin-top: 6px"><i class="bi bi-plus-lg me-1"></i> Tambah</button></a>
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody class="text-uppercase" style="height: 45px;font-size:13px;">
                                        ...
                                        <td class="text-capitalize"><a href="/category-sub-tickets/{{ $sct->id }}/edit" class="text-primary"><i class="bi bi-pencil-square"></i> Edit</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
