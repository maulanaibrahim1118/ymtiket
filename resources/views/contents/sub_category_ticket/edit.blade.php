                            ...
                            <div class="card-body pb-0">
                                ...
                                <form class="row g-3 mb-3" action="/category-sub-tickets/{{ $sct->id }}" method="POST">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="nama_sub_kategori" class="form-control text-capitalize @error('nama_sub_kategori') is-invalid @enderror" id="nama_sub_kategori" value="{{ old('nama_sub_kategori', $sct->nama_sub_kategori) }}" required>
