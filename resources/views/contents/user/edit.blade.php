                            ...
                            <div class="card-body pb-0">
                                ...
                                <form class="row g-3 mb-3" action="{{ route('user.update', ['id' => encrypt($user->id)]) }}" method="POST">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="nik" pattern="[0-9]+" class="form-control text-capitalize @error('nik') is-invalid @enderror" id="nik" value="{{ old('nik', $user->nik) }}" maxlength="9" title="Tolong di input dalam bentuk nomor." placeholder="No. Induk Karyawan...">
