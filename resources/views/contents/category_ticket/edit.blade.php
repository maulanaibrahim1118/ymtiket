                            ...
                            <div class="card-body pb-0">
                                ...
                                <form class="row g-3 mb-3" action="/category-tickets/{{ $ct->id }}" method="POST">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="nama_kategori" class="form-control text-capitalize @error('nama_kategori') is-invalid @enderror" id="nama_kategori" value="{{ old('nama_kategori', $ct->nama_kategori) }}" required>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select @error('location_id') is-invalid @enderror" name="location_id" id="location_id" value="{{ old('location_id') }}">
                                            ...
                                            @foreach($locations as $location)
                                                @if(old('location_id', $ct->location_id) == $location->id)
