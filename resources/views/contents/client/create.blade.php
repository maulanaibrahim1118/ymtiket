                            ...
                            <div class="card-body pb-0">
                                ...
                                <form class="row g-3 mb-3" action="/clients" method="POST">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <input type="text" name="nik" class="form-control text-capitalize @error('nik') is-invalid @enderror" id="nik" value="{{ old('nik') }}" required>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="telp" class="form-control text-capitalize @error('telp') is-invalid @enderror" id="telp" value="{{ old('telp') }}" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="ip_1" id="ip1" class="form-control text-center d-inline" style="width:11%;margin-right:5px;" maxlength="3" value="{{ old('ip_1') }}" required><b>.</b>
                                        <input type="text" name="ip_2" id="ip2" class="form-control text-center d-inline" style="width:11%;margin-right:5px;" maxlength="3" value="{{ old('ip_2') }}" required><b>.</b>
                                        <input type="text" name="ip_3" id="ip3" class="form-control text-center d-inline" style="width:11%;margin-right:5px;" maxlength="3" value="{{ old('ip_3') }}" required><b>.</b>
                                        <input type="text" name="ip_4" id="ip4" class="form-control text-center d-inline" style="width:11%;margin-right:5px;" maxlength="3" value="{{ old('ip_4') }}" required>
                                    </div>
