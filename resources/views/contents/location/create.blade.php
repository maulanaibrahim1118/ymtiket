                            ...
                            <div class="card-body pb-0">
                                ...
                                <form class="row g-3 mb-3" action="/locations" method="POST">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <input type="text" name="inisial" class="form-control text-uppercase @error('inisial') is-invalid @enderror" id="inisial" value="{{ old('inisial') }}" maxlength="3" required>
