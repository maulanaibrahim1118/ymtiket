                    ...
                    <div class="col-12">
                        <div class="card info-card">
                            <div class="card-body pb-0">
                                ...
                                <form class="row g-3 mb-3" action="{{ route('location.update', ['id' => encrypt($location->id)]) }}" method="POST">
                                    @method('put')
                                    @csrf
                                    <div class="col-md-1">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <input type="text" name="initial" class="form-control text-capitalize @error('initial') is-invalid @enderror" id="initial" maxlength="5" value="{{ old('initial', $location->initial) }}">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="ip_address" class="form-control text-capitalize @error('ip_address') is-invalid @enderror" id="ip_address" value="{{ old('ip_address', $location->user->ip_address) }}" required>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="regional" class="form-control text-capitalize bg-light @error('regional') is-invalid @enderror" id="regional" value="{{ old('regional', $location->wilayah->regional->name) }}" readonly>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="area" class="form-control text-capitalize bg-light @error('area') is-invalid @enderror" id="area" value="{{ old('area', $location->wilayah->regional->area->name) }}" readonly>
