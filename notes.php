...
Revisi:
<!--
1. Service desk dapat mengantri kan ticket untuk agent. (done)
2. Service desk dapat meng assign ticket secara direct ke agent. (done)
3. Ticket baru yang diantri kan oleh service desk untuk agent, akan muncul otomatis ke agent setelah ticket sebelumnya di resolved. (done)
4. Service desk dapat mengatur status agent, apakah libur, izin, sakit, cuti, dan tugas keluar kota. (done)
5. Agent tidak akan mendapat ticket baru jika sedang libur, izin, sakit, cuti, dan tugas keluar kota. (done)
